...
public class UndirectedWeightedGraph {
    ...
    public UndirectedWeightedGraph(int vertexCount) {
    ...
    public static UndirectedWeightedGraph fromFile(String file) {
        ...
        try {
            ...
            int maxIndex = parseResult.stream().flatMapToInt(x -> Arrays.stream(new int[]{x[0], x[1]})).max().getAsInt();
            UndirectedWeightedGraph graph = new UndirectedWeightedGraph(maxIndex + 1);
    ...
    public UndirectedWeightedGraph clone() {
        UndirectedWeightedGraph graph = new UndirectedWeightedGraph(vertices.size());
    ...
    public void addEdge(int v, int w, double weight) {
        ...
        vertices.get(w).addEdgeTo(v, weight);
    }
    ...
    public Vertex getRootVertex() {
        if (getNodeCount() == 0) throw new RuntimeException("UndirectedWeightedGraph is empty\n");
